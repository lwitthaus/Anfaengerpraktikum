...
\begin{equation}
  \sigma_f = \sqrt{
      \left( \frac{\partial \left(\frac{\symup{d}T}{\symup{d}t}\right)}{\partial A} \sigma_A \right)^{\!\! 2} +
      \left( \frac{\partial \left(\frac{\symup{d}T}{\symup{d}t}\right)}{\partial B} \sigma_B \right)^{\!\! 2}
    }
\end{equation}
