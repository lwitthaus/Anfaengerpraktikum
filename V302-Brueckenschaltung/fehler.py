...
#R_q = ufloat(0.667, 0.003)
#C_1 = C_q * R_q
#print(C_1)


#C_w = ufloat(597*10**(-9), 1*10**(-9))
#R_w = ufloat(1.110, 0.006)
#C_2 = C_w * R_w
#print(C_2)

#C_e = ufloat(399*10**(-9), 1*10**(-9))
#R_e = ufloat(1.660, 0.008)
#C_3 = C_e * R_e
#print(C_3)
...
#C_w = ufloat(597*10**(-9), 1*10**(-9))
#R_w = ufloat(0.704, 0.004)
#C_2 = C_w * R_w
#print(C_2)

#C_q = ufloat(992*10**(-9), 2*10**(-9))
#R_q = ufloat(0.422, 0.002)
#C_3 = C_q * R_q
#print(C_3)
...
#Kapazität (Wert 8)
#C_q = ufloat(992*10**(-9), 2*10**(-9))
#R_q = ufloat(0.297, 0.001)
#C_1 = C_q * R_q
#R_a = ufloat(170, 5.1)
#print(C_1)
#
#C_w = ufloat(597*10**(-9), 1*10**(-9))
#R_w = ufloat(0.490, 0.002)
#C_2 = C_w * R_w
#print(C_2)
#
#C_e = ufloat(399*10**(-9), 1*10**(-9))
#R_e = ufloat(0.736, 0.004)
#C_3 = C_e * R_e
#print(C_3)
#
...
#R_a = ufloat(170, 5.1)
#R_q = ufloat(1/0.30, 0.02)
#R_1 = R_a * R_q
#print(R_1)
#
#R_b = ufloat(281, 8.43)
#R_w = ufloat(1/0.49, 0.01)
#R_2 = R_b * R_w
#print(R_2)
#
#R_c = ufloat(422, 12.66)
#R_e = ufloat(1/0.736, 0.007)
#R_3 = R_c * R_e
#print(R_3)
#
